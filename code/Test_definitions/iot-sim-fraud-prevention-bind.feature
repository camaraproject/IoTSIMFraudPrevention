Feature: CAMARA IoT SIM Fraud Prevention API, v0.1.0-rc.1 - Operation bindDeviceImei
    ...
    #
    # Testing assets:
    # * A valid device identifier (phoneNumber, ipv4Address, ipv6Address or networkAccessIdentifier) for which the binding operations can be performed
    # * A valid access token with scope "iot-sim-fraud-prevention:bind"
  ...
  Background: Common bindDeviceImei setup
    ...
    And the resource "/iot-sim-fraud-prevention/v0.1rc1/bind"
